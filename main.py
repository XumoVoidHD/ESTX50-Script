...
class Strategy:
    ...
    def __init__(self):
        ...
        self.send_discord_message = False
    ...
    async def place_atm_call_order(self):
        ...
        try:
            ...
            if self.atm_call_sl <= 10:
                self.atm_call_sl = round(self.atm_call_sl, 1)
            elif 10 <= self.atm_call_sl < 25:
                self.atm_call_sl = round(self.atm_call_sl*4)/4
            else:
                self.atm_call_sl = round(self.atm_call_sl * 2) / 2
    ...
    async def place_atm_put_order(self):
        ...
        try:
            ...
            if self.atm_put_sl <= 10:
                self.atm_put_sl = round(self.atm_put_sl, 1)
            elif 10 <= self.atm_put_sl < 25:
                self.atm_put_sl = round(self.atm_put_sl*4)/4
            else:
                self.atm_put_sl = round(self.atm_put_sl * 2) / 2
